...
            // CASH: 1. Add order, 2. Deduct inventory, 3. Clear cart immediately
            await addDoc(collection(db, "DeliveryOrders"), commonOrderData);

            // FULFILLMENT for Cash (Immediate)
...
            
            // E-PAYMENT: 1. Add order to DeliveryOrders with "Pending" status
...
                        **userId: currentUser.uid, // Keep the userId for optional webhook use**
                    }
                }),
            });
