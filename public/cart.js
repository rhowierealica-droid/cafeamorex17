      ...
      cartItems.forEach(item => {
        ...
        itemDiv.innerHTML = `
          <div style="display:flex; align-items:center; gap:15px;">
            ...
            <img src="${item.image || 'placeholder.png'}" alt="${item.name}" style="height:80px; width:80px; object-fit:cover; border-radius:8px; flex-shrink:0;">
            <div class="item-info">
    ...
    .forEach(item => {
      ...
      modalCartItemsDiv.innerHTML += `
        <div class="modal-cart-item" style="display:flex; align-items:center; gap:12px; margin-bottom:8px;">
          <img src="${item.image || 'placeholder.png'}" alt="${item.name}" style="height:60px; width:60px; object-fit:cover; border-radius:6px; flex-shrink:0;">
          <div>
            <strong>${item.name}</strong><br>
