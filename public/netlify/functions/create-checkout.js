    ...
    try {
        const response = await axios.post(
            `${PAYMONGO_API}/checkout_sessions`,
            {
                data: {
                    attributes: {
                        success_url: process.env.SUCCESS_URL || 'https://amorex17.netlify.app/customer-status.html',
                        cancel_url: process.env.CANCEL_URL || 'https://amorex17.netlify.app/cart.html',
